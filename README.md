...
Using the **Gemini 1.5 Flash** LLM and a **RAG (Retrieval-Augmented Generation)** pipeline, this web app allows residents to ask natural language questions and receive accurate, cited answers directly from the 500+ page OCP and its associated engagement reports (Phases 1-4).
